...
def print_cheapest_books():
    ...
    cheapest_books = sorted(app.books, key=lambda x: x.price)[:10]
...
books_generator = (book for book in app.books)
def get_next_book():
    logger.info('Getting next book from generator of all books...')    
    print(next(books_generator))

""""
# First menu implementation. Below this method it is presented a more efficient
# way of creating a user menu.
def "menu():
